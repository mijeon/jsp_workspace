...
<%
	...
	//만일 사용자가 검색기능을 이용해 파라미터를 넘기면, 그 파라미터값을 맵에 채워서 selectAll()에 호출
	String category=request.getParameter("category");
	String keyword=request.getParameter("keyword");
	HashMap<String, String> map=new HashMap<String, String>();
	map.put("category", category);  //사용자가 선택한 select box의 값
	map.put("keyword", keyword);  //사용자가 입력한 키워드 text box의 값
